...
export class PanStore {
  ...
  async claimWithLease({
    ...
    // re-check its state below. Route the write through the already-read
    // `current` item so it targets the owning (possibly external) repository,
    // and forward beforeWrite so each field write reauthorizes the scope.
