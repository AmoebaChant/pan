...
export const CANONICAL_FIELDS = [
  {
    ...
    options: [
      ...
      'done',
      'rejected',
      // Additive pilot recovery options. New lifecycle logic does not write
      // these values, but reconciliation must preserve current installations.
      'untriaged',
      'needs-detail',
      'ready',
      'in-progress',
  ...
  },
  {
    name: 'next-action',
    type: 'single-select',
    options: ['clarify', 'discuss', 'approve', 'review', 'act', 'execute', 'wait', 'hold', 'none'],
  },
  ...
  { name: 'execution-authorized', type: 'single-select', options: ['no', 'yes'] },
  { name: 'dependencies', type: 'text' },
  {
    name: 'worker-state',
    type: 'single-select',
    options: ['idle', 'starting', 'running', 'waiting-human', 'checkpointed', 'paused', 'uncertain', 'stopped'],
  },
